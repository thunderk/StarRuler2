...
MessageHandler::MessageHandler() : active(true) {}

void MessageHandler::queueMessage(Transport *transport, Address addr,
                                  Message *msg) {
  QueuedMessage q;
...
void MessageHandler::handleMessage(Transport *transport, Address addr,
                                   Message *msg) {
  delete msg;
  transport->drop();
}
