...
public:
  ...
  bool changeDesign(const Design *older, const Design *newer,
                    DesignClass *cls = nullptr);
  void setDesign(const Design *older, const Design *newer,
                 DesignClass *cls = nullptr);
  ...
  void sendDesign(net::Message &msg, const Design *dsg,
