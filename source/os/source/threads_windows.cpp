...
int atomic_int::operator++() { return _InterlockedIncrement(&value); }

int atomic_int::operator++(int) {
  return (int)_InterlockedIncrement(&value) - 1;
}

int atomic_int::operator--() { return (int)_InterlockedDecrement(&value); }
...
_threadlocalPointer::~_threadlocalPointer() { TlsFree(index); }

void _threadlocalPointer::set(void *ptr) { TlsSetValue(index, ptr); }

void *_threadlocalPointer::get() { return TlsGetValue(index); }
...
int compare_and_swap(int *ptr, int oldval, int newval) {
  return (int)_InterlockedCompareExchange((long *)ptr, (long)newval,
                                          (long)oldval);
}
...
void *compare_and_swap(void **ptr, void *oldval, void *newval) {
  return (void *)_InterlockedCompareExchange64(
      (long long *)ptr, (long long)newval, (long long)oldval);
}
#else
void *swap(void **ptr, void *newval) {
...
void *compare_and_swap(void **ptr, void *oldval, void *newval) {
  return (void *)_InterlockedCompareExchange((long *)ptr, (long)newval,
                                             (long)oldval);
}
#endif
