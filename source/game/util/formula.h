...
public:
  ...
  virtual double evaluate(varInterpreter VarConverter = nullConverter,
                          void *UserPointer = nullptr,
                          varIndexInterpreter VarIndexConverter = 0) = 0;
  virtual ~Formula() {}

  // Creates a formula from infix notation
  // Can throw FormulaError if there is an error in the expression
  static Formula *fromInfix(const char *expression,
                            varIndexConverter VarConverter = 0,
