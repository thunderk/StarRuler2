...
struct Game {
  ...
  Game()
      : players(0), maxPlayers(0), started(false), isLocal(false), listed(true),
        password(false), punchPort(-1), version(0) {}
...
struct LobbyQuery {
  ...
  LobbyQuery(const std::string &hostname, int port, int BroadcastPort = -1,
