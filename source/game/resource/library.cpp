...
#define access_ref(type, func)                                                 \
  Library::ResourceAccessor::operator const type &() {                         \
    return source->func(name);                                                 \
  }                                                                            \
  Library::ResourceAccessor::operator const type *() {                         \
    return &source->func(name);                                                \
  }
...
const render::MaterialGroup &
Library::getMaterialGroup(const std::string &name) const {
...
const render::SpriteSheet &
Library::getSpriteSheet(const std::string &name) const {
...
Library::getParticleSystem(const std::string &name) const {
