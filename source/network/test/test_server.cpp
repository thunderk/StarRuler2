...
void test_server() {
  ...
  srv.connHandle(net::MT_Connect, [](net::Server &srv, net::Connection &conn,
                                     net::Message &mess) {
    printf("Connection from %s\n", conn.address.toString().c_str());
  });

  srv.connHandle(net::MT_Disconnect, [](net::Server &srv, net::Connection &conn,
                                        net::Message &mess) {
  ...
  srv.connHandle(
      net::MT_Application,
      [](net::Server &srv, net::Connection &conn, net::Message &mess) {
        char *str = 0;
        mess >> str;
