...
static void cb_keybind(profile::BindGroup *grp, const std::string &name,
...
static void cb_keybind_id(profile::BindGroup *grp, unsigned id,
                          const std::string &str) {
  std::string decl("void ");
  decl += str;
  decl += "(bool)";
...
static unsigned cb_group_cnt() { return devices.keybinds.groups.size(); }
...
void saveSettings() {
  devices.settings.engine.saveSettings(
      path_join(getProfileRoot(), "settings.txt"));
  devices.settings.mod.saveSettings(
...
void RegisterProfileBinds() {
  ...
  grp.addExternMethod("void addBind(const string &in, const string &in)",
                      asFUNCTION(cb_keybind));
  grp.addExternMethod("void addBind(Keybind, const string &in)",
                      asFUNCTION(cb_keybind_id));
  ...
  grp.addExternMethod("void setBind(int key, Keybind bind)",
                      asFUNCTION(cb_set_kb));
  grp.addExternMethod("void clearBin(int key)", asFUNCTION(cb_clear_kb));
  grp.addExternMethod("void clearBinds(Keybind bind)",
                      asFUNCTION(cb_clear_kb_bind));

  grp.addExternMethod("void setDefaultBinds(Keybind bind)",
                      asFUNCTION(cb_setdef_kb));
  grp.addExternMethod("void setDefaultBinds()", asFUNCTION(cb_setdef_kb_all));

  grp.addExternMethod("uint getDefaultKeyCount(Keybind bind)",
                      asFUNCTION(cb_defcount));
  grp.addExternMethod("int getDefaultKey(Keybind bind, uint index)",
                      asFUNCTION(cb_defkey));

  grp.addExternMethod("uint getCurrentKeyCount(Keybind bind)",
                      asFUNCTION(cb_curcount));
  grp.addExternMethod("int getCurrentKey(Keybind bind, uint index)",
                      asFUNCTION(cb_curkey));
  ...
  bind("int getKeyFromDisplayName(string key)",
       asFUNCTION(profile::getKeyFromDisplayName));
  bind("string getKeyDisplayName(int key)",
       asFUNCTION(profile::getKeyDisplayName));
  ...
  bind("void setSettingBool(const string &in, bool)",
       asFUNCTION(setSetting_bool));
  bind("void setSettingDouble(const string &in, double)",
       asFUNCTION(setSetting_double));
  bind("void setSettingStr(const string &in, const string &in)",
       asFUNCTION(setSetting_str));
  ...
  bind("double getSettingDouble(const string &in)",
       asFUNCTION(getSetting_double));
  bind("const string& getSettingStr(const string &in)",
       asFUNCTION(getSetting_str));

  bind("int getSettingMaxInt(const string &in)",
       asFUNCTION(getSetting_max_int));
  bind("int getSettingMinInt(const string &in)",
       asFUNCTION(getSetting_min_int));
  bind("double getSettingMaxDouble(const string &in)",
       asFUNCTION(getSetting_max_double));
  bind("double getSettingMinDouble(const string &in)",
       asFUNCTION(getSetting_min_double));
